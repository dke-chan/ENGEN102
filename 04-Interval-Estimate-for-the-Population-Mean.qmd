...
se(x¯)
  should look familiar—revisit Slide 12

The critical difference is that se(x¯)
 is quantified with a statistic, whereas the latter, σx¯
, is defined in terms of σ
, a ground “truth” about the spread of all possible values
...
In particular, the Student’s t-distribution allows us to quantify the precision of x¯
, our best estimate of μ
, for any sample size (with some assumptions)

## [Ex 5:]{style='color: tomato;'} Student Textbook Spending

A randomly selected sample of 12 students at a university was asked “How much did you spend for textbooks this semester?”1
...
Calculate a 95% confidence interval for the population mean spend on textbooks.

Interpret

  <li class="fragment" data-fragment-index=2>The confidence level</li>
  <li class="fragment" data-fragment-index=3>That it is an estimate of the ground ["truth"]{style="color: cornflowerblue"} (parameter) of ...</li>
  <li class="fragment" data-fragment-index=4>The lower and upper bounds of the confidence interval are quantified with units (where applicable)</li>
