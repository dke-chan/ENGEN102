...
- A mole has a weight that is between 150 to 200 grams.
...
- The [probability]{.orchid} of a randomly selected mole has a weight that is between 150 to 200 grams. [&zigrarr; $\mathbb{P}(150 < X < 200)$]{.printOnly}
...
# Calculate P(150 < X < 200)
integrate.quad(stats.norm.pdf, 150, 200, args = (150, 65))[0]
```
...
# Calculate P(X < 100)
integrate.quad(stats.norm.pdf, -math.inf, 100, args = (150, 65))[0]
```
...
integrate.quad(stats.norm.pdf, 124.5, 125.5, args = (150, 65))[0]
```
::::

## Calculation of Probabilities by hand

To do this by hand, we standardise the random variable using a z score and use Z ~ Normal Plus Table A.

## Percentiles with Normal Random Variables

## Empirical Rule for Normal Distributions

Let $X \sim \text{Normal}(\mu, \sigma)$.
