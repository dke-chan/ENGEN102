...
::: {.aside}
Wickham, H., Çetinkaya-Rundel, M., & Grolemund, G. (in press). *R for Data Science* (2nd ed.). O'Reilly.
:::
...
<ol>
  ...
  <li class="fragment" data-fragment-index=3> <ul>
    ...
    <li class="fragment" data-fragment-index=4> If $n$ is **even**, then $m$ is the *mean* of the values from the observations "above" and "below" $\frac{n + 1}{2}$ </li>
  </ul> </li>
</ol>
...
| [Variables]{style="color: #4758AB;"} | |
| :-           | :------------ |
| **score** | A numeric variable denoting the test score (unitless) |
| **method** | A categorical variable denoting the note taking method, "longhand" or "laptop" |
::::
:::::
