...
:::: {.columns}
::: {.column width="65%"}
Percentile values, *t*^\*^~[*p*]{.ch-0}~(*&nu;*), for the Student's *t*-distribution with *&nu;* degrees of freedom. Note that the partial area is $\mathbb{P}(T < t^*_p\,(\nu)) = p$, where $T \sim \text{Student}(\nu)$.
:::
::: {.column width="35%"}
```{r}
#| echo: false
