...
## Interpretation of the Outcome of the Hypothesis Test
...
<ol style="margin-top: -25px;">
  <li class="fragment" data-fragment-index=0> Observations are independent.
  <li class="fragment" data-fragment-index=1> One measure of centre is an appropriate summary of the data.
  <li class="fragment" data-fragment-index=2> The data is approximately symmetrical about its sample mean.
  <li class="fragment" data-fragment-index=3> No outliers.
</ol>

. . .

::: {style="border-bottom: 5px solid orange; width: 50%;"}
3. and 4. in practice: 
:::
...
<ol style="line-height: 1.1; font-size: 0.8em;">
  <li style="margin-bottom: 50pt;">
    <ol>
      ...
      <li style="list-style-type: lower-alpha; line-height: 1.1; font-size: 1em;">
      Interpret the outcome of the hypothesis test conducted for [**Ex 5**]{.red} at the 5% level.
      </li>
    </ol>
  </li>
...
<!-- A chemist has developed a new polymer for creating high-tensile strength string. -->
<!-- He wants to test whether the average weight that can be suspended by this new -->
<!-- string before the string breaks is different from the breaking strength of the -->
<!-- previous string used for a particular application. -->
<!-- 10 measurements are made of the weight (in kilograms) the new string can bear -->
<!-- before it snaps: -->
<!-- 5.73, 6.21, 5.85, 5.92, 5.97, 6.15, 6.05, 5.87, 5.91, 5.88 -->
<!-- The string in current use has a mean breaking strength of 5.8 kg. Based on these -->
<!-- trials, is there any evidence to suggest the new string has a different average -->
<!-- breaking strength than the old string? Test at the 5% significance level. -->
