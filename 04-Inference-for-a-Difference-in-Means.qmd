...
<ol style="margin-top: -25px;">
  <li class="fragment" data-fragment-index=0> The two groups are independent.
  <li class="fragment" data-fragment-index=1> *Within* group: <ol style="list-style-type: lower-alpha;">
    <li class="fragment" data-fragment-index=1> Observations are independent.
    <li class="fragment" data-fragment-index=2> One measure of centre is an appropriate summary of the data.
    <li class="fragment" data-fragment-index=3> The data is approximately symmetrical about its sample mean.
    <li class="fragment" data-fragment-index=4> No outliers.
  </ol>
</ol>

. . .

Like _**Inference on the Mean**_, we are more lenient with the final two assumptions with *large* sample sizes.
...
<ol style="line-height: 1.1; font-size: 0.8em;">
  <li style="margin-bottom: 50pt;">
    <ol>
      ...
      <li style="list-style-type: lower-alpha; line-height: 1.1; font-size: 1em;">
      Interpret the outcome of the hypothesis test conducted for [**Ex 7**]{.red} at the 5% level.
      </li>
    </ol>
  </li>
  
  <li style="margin-bottom: 50pt;">
  Suppose we plotted data typically analysed when conducting inference for a difference in means setting. Which assumptions for inference can be checked with the plot?
  </li>
...
$$
  You can answer the following questions as if the assumptions for inference have been met.
    <ol>
      ...
      <li style="list-style-type: lower-alpha; line-height: 1.1;">
      Interpret the outcome of the hypothesis test conducted at the 5% level.
      </li>
    </ol>
